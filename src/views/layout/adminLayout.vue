    ...
    >
      ...
      >
        ...
        <v-list-group value="Element">
          ...
          <v-list-item title="Containment" :to="'/element/containment'">
          </v-list-item>
          ...
          <v-list-item title="form" :to="'/element/form'"> </v-list-item>
...
export default {
  ...
  methods: {
    handleResize() {
      ...
      this.windowWidth < 960 ? (this.railWidth = 1) : (this.railWidth = 80);
